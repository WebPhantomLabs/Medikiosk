...
class InMemoryDatabase:
    ...
    def seed_defaults(self) -> None:
        ...
        self.tables["question_bank"] = [
            ...
            {
                "node_id": "OTHER_SYMPTOMS",
                "question_text": "Do you have any other symptoms you'd like to mention?",
                "question_type": "single_choice",
                "is_start_node": False,
                "is_terminal": False,
                "active": True,
            ...
            },
            {
                ...
                "question_text": "What is your body constitution type? (Vata/Pitta/Kapha)",
                "question_type": "single_choice",
                "is_start_node": True,
                "is_terminal": False,
                "active": True,
                "branch": "ayurveda",
                "metadata": {"category": "prakriti", "branch": "ayurveda", "translations": {"hi": "आपके शरीर की प्रकृति क्या है? (वात/पित्त/कफ)"}},
                "created_at": datetime.now(UTC).isoformat(),
                "updated_at": datetime.now(UTC).isoformat(),
            },
            {
                "node_id": "ayurveda_vata_symptoms",
                "question_text": "Describe your main discomfort - pain location, dryness, anxiety, sleep issues",
                "question_type": "single_choice",
                "is_start_node": False,
                "is_terminal": False,
                "active": True,
                "branch": "ayurveda",
                "metadata": {"category": "vata", "branch": "ayurveda", "translations": {"hi": "अपनी मुख्य परेशानी बताएं - दर्द की जगह, सूखापन, चिंता, नींद की समस्या"}},
                "created_at": datetime.now(UTC).isoformat(),
                "updated_at": datetime.now(UTC).isoformat(),
            },
            {
                "node_id": "ayurveda_pitta_symptoms",
                "question_text": "Describe your main discomfort - burning, acidity, inflammation, irritability",
                "question_type": "single_choice",
                "is_start_node": False,
                "is_terminal": False,
                "active": True,
                "branch": "ayurveda",
                "metadata": {"category": "pitta", "branch": "ayurveda", "translations": {"hi": "अपनी मुख्य परेशानी बताएं - जलन, एसिडिटी, सूजन, चिड़चिड़ापन"}},
                "created_at": datetime.now(UTC).isoformat(),
                "updated_at": datetime.now(UTC).isoformat(),
            },
            {
                "node_id": "ayurveda_kapha_symptoms",
                "question_text": "Describe your main discomfort - heaviness, congestion, lethargy, swelling",
                "question_type": "single_choice",
                "is_start_node": False,
                "is_terminal": False,
                "active": True,
                "branch": "ayurveda",
                "metadata": {"category": "kapha", "branch": "ayurveda", "translations": {"hi": "अपनी मुख्य परेशानी बताएं - भारीपन, जकड़न, सुस्ती, सूजन"}},
                "created_at": datetime.now(UTC).isoformat(),
                "updated_at": datetime.now(UTC).isoformat(),
            },
            {
                "node_id": "ayurveda_digestive",
                "question_text": "How is your digestion? Any constipation, loose stools, or irregular appetite?",
                "question_type": "single_choice",
                "is_start_node": False,
                "is_terminal": False,
                "active": True,
                "branch": "ayurveda",
                "metadata": {"category": "digestive", "branch": "ayurveda", "translations": {"hi": "आपका पाचन कैसा है? कोई कब्ज, पतले दस्त, या अनियमित भूख?"}},
                "created_at": datetime.now(UTC).isoformat(),
                "updated_at": datetime.now(UTC).isoformat(),
            },
            {
                "node_id": "ayurveda_complete",
                "question_text": "Thank you. Your responses have been recorded for the Vaidya.",
                "question_type": "info",
                "is_start_node": False,
                "is_terminal": True,
                "active": True,
                "branch": "ayurveda",
                "metadata": {"category": "terminal", "branch": "ayurveda", "translations": {"hi": "धन्यवाद। आपके उत्तर वैद्य के लिए दर्ज कर लिए गए हैं।"}},
                "created_at": datetime.now(UTC).isoformat(),
                "updated_at": datetime.now(UTC).isoformat(),
            },
        ]
        ...
        self.tables["question_transitions"] = [
            ...
            {"id": "t4", "node_id": "CHIEF_COMPLAINT", "answer_category": "OTHER", "next_node_id": "OTHER_SYMPTOMS"},
            {"id": "t5", "node_id": "FEVER_DURATION", "answer_category": "LESS_THAN_3_DAYS", "next_node_id": "OTHER_SYMPTOMS"},
            {"id": "t6", "node_id": "FEVER_DURATION", "answer_category": "3_OR_MORE_DAYS", "next_node_id": "OTHER_SYMPTOMS"},
            {"id": "t7", "node_id": "COUGH_TYPE", "answer_category": "DRY", "next_node_id": "OTHER_SYMPTOMS"},
            {"id": "t8", "node_id": "COUGH_TYPE", "answer_category": "PRODUCTIVE", "next_node_id": "OTHER_SYMPTOMS"},
            {"id": "t9", "node_id": "PAIN_SEVERITY", "answer_category": "MILD", "next_node_id": "OTHER_SYMPTOMS"},
            {"id": "t10", "node_id": "PAIN_SEVERITY", "answer_category": "MODERATE", "next_node_id": "OTHER_SYMPTOMS"},
            {"id": "t11", "node_id": "PAIN_SEVERITY", "answer_category": "SEVERE", "next_node_id": "OTHER_SYMPTOMS"},
            {"id": "t12", "node_id": "OTHER_SYMPTOMS", "answer_category": "YES", "next_node_id": "TRIAGE_COMPLETE"},
            {"id": "t13", "node_id": "OTHER_SYMPTOMS", "answer_category": "NO", "next_node_id": "TRIAGE_COMPLETE"},
            {"id": "t14", "node_id": "ayurveda_prakriti_start", "answer_category": "VATA", "next_node_id": "ayurveda_vata_symptoms"},
            {"id": "t15", "node_id": "ayurveda_prakriti_start", "answer_category": "PITTA", "next_node_id": "ayurveda_pitta_symptoms"},
            {"id": "t16", "node_id": "ayurveda_prakriti_start", "answer_category": "KAPHA", "next_node_id": "ayurveda_kapha_symptoms"},
            {"id": "t17", "node_id": "ayurveda_vata_symptoms", "answer_category": "DEFAULT", "next_node_id": "ayurveda_digestive"},
            {"id": "t18", "node_id": "ayurveda_pitta_symptoms", "answer_category": "DEFAULT", "next_node_id": "ayurveda_digestive"},
            {"id": "t19", "node_id": "ayurveda_kapha_symptoms", "answer_category": "DEFAULT", "next_node_id": "ayurveda_digestive"},
            {"id": "t20", "node_id": "ayurveda_digestive", "answer_category": "DEFAULT", "next_node_id": "ayurveda_complete"},
        ]
